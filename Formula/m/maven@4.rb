class MavenAT4 < Formula
  ...
  url "https://www.apache.org/dyn/closer.lua?path=maven/maven-4/#{version}/binaries/apache-maven-#{version}-bin.tar.gz"
  mirror "https://archive.apache.org/dist/maven/maven-4/#{version}/binaries/apache-maven-#{version}-bin.tar.gz"
  version "4.0.0-rc-5"
